...
export default function HeroSection() {
    return (
        ...
        <div>
            ...
            <Image src='/hero.jpg' alt='Hero Image' width={1920} height={600} className=" relative w-full h-screen object-cover"/>

            <div className="absolute top-1/3 pl-12 text-white">
                ...
                <div className="grid grid-cols-2 mt-6 items-center gap-2">
