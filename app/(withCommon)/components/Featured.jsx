...
export default function Featured(){
    return(
        ...
        <div className="my-12">
            ...
            <p className="max-w-4xl mx-auto text-md md:text-lg mt-2 text-center">Our specially selected heritage chicken breeds combine beauty, temperament, and productivity. These time-tested varieties are perfect for both beginners and experienced chicken keepers.</p>
