...
export default function Contact() {
    return ( 
        <div id="contact" className="bg-gray-100 py-12">
            ...
            <h3 className=" text-2xl md:text-4xl font-bold md:text-center">Contact Us</h3>
            <div className="w-32 h-1 bg-amber-500 my-2 mx-auto"></div>
            <p className="max-w-3xl text-gray-600 text-center mx-auto py-4 md:pb-8">Have questions about our chickens, ordering process, or need advice? We're here to help! Fill out the form below and we'll get back to you as soon as possible.</p>

            
            <div className="grid grid-cols-1 md:grid-cols-2 md:max-w-3xl md:mx-auto">
                <div className="text-white bg-[#d97706] py-6 px-6 mx-4 md:mx-0 rounded-l-lg">
                ...
                <div className="">
                    <form className="bg-white p-6 rounded-r-lg shadow-md">
                        <div className="mb-4">
